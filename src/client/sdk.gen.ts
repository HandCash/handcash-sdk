...
export class Connect {
     ...
     * Get items inventory
     */
    public static postV3ConnectItemsInventory<ThrowOnError extends boolean = false>(options: Options<PostV3ConnectItemsInventoryData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).post<PostV3ConnectItemsInventoryResponses, unknown, ThrowOnError>({
            security: [
                {
                    name: 'oauth-publickey',
                    type: 'apiKey'
