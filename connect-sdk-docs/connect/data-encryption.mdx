...
> This module is useful in case you need the user identity to encrypt data that is not stored in the blockchain. If you want to store the encrypted data in the blockchain, please refer to [attach data to payments](/connect/payments#attach-data).
