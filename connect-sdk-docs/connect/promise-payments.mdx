...
Promise payments are similar to [instant payments](/connect/payments). The difference is that promise payments allow you to commit the amount of money being spent and update the payment amount or data as time goes on. Eventually you can broadcast the promise to finalize the payment.
